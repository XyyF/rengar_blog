...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(53), __webpack_require__(231).setImmediate))
...
var DialogType = exports.DialogType = {
     ...
     * 弹框样式
     */
};var DialogStyle = exports.DialogStyle = {
    // 居中显示
     ...
     */
};var componentConfigs = exports.componentConfigs = [{
    // 联系我
    type: DialogType.CALL_ME,
    loader: function loader() {
        return new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 258));
    },
    ...
    loader: function loader() {
        return new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 259));
    },
...
var _baseVue = __webpack_require__(234);

var _baseVue2 = _interopRequireDefault(_baseVue);

var _anm = __webpack_require__(291);

var _anm2 = _interopRequireDefault(_anm);

var _browser = __webpack_require__(153);
...
// 动画
var app = new _vue2.default(_baseVue2.default);
// 浏览器判断
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(53), __webpack_require__(233)))
...
var _regenerator = __webpack_require__(235);

var _regenerator2 = _interopRequireDefault(_regenerator);

var _asyncToGenerator2 = __webpack_require__(238);
...
var _clickoutside = __webpack_require__(256);
...
var _dialog_configs = __webpack_require__(105);
...
exports.default = {
    ...
    components: (0, _defineProperty3.default)({}, _index2.default.name, _index2.default),
    mixins: [_index4.default, _index6.default],
    data: function data() {
    ...
    methods: {
        /* Notice: 复杂的方法，写下说明 */
        // 点击联系我显示微信加好友
        showCallMe: function showCallMe() {
            this.$dialog.showDialog(_dialog_configs.DialogType.CALL_ME);
        },

        // 获取当前文章的url
        goToArchive: function goToArchive(tag) {
            var year = new Date(tag.date).getFullYear();
            var month = new Date(tag.date).getMonth();
            var date = new Date(tag.date).getDate();
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            // 防止页面先行显示出来
                            _this.renderContainer = true;
                            _this.$nextTick(function () {
                                _vue2.default.prototype.$dialog = _this.$refs.dialog;
                            });
...
var userAgent = __webpack_require__(249);
 ...
 */
(0, _event.on)(document, 'mousedown', down);
(0, _event.on)(document, 'mouseup', up);
...
exports.default = {
    ...
    bind: function bind(el, binding, vnode) {
        ...
        var handleClickOutSide = function handleClickOutSide() {
            var mousedown = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
            var mouseup = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

            if (!vnode.context || !mouseup.target || !mousedown.target || el.contains(mouseup.target) || el.contains(mousedown.target) || el === mouseup.target || el === mousedown.target) {
                return;
            }
...
var loadingCircle = document.createElementNS('http://www.w3.org/2000/svg', 'circle');
...
exports.default = {
    ...
    render: function render(h) {
        ...
        // 头部信息
        var createCatalogTitle = function createCatalogTitle(h) {
            return h('div', {
                attrs: {
                    'class': 'catalog-top'
                },
        ...
        // 内容信息
        var createCatalogContent = function createCatalogContent(h) {
            return h('div', {
                attrs: {
                    'class': 'catalog-content'
                },
                domProps: {
                    innerHTML: _this.dialogData.catalogHtml
                }
            });
        };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1a7fa6a0_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(270);
...
/* scopeId */
var __vue_scopeId__ = "data-v-1a7fa6a0"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1a7fa6a0_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
...
var update = __webpack_require__(75)("09b1fa1c", content, true, {});
...
var LOADING_DIALOG_PENDDING_TIME = 300; //
//
//
//
//
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            // 弹窗的默认样式
            dialogClass: _dialog_configs.DialogStyle.MIDDLE_DIALOG,
            // 当前弹窗状态
            dialogState: STATE_CLOSED,
            // 当前打开的弹窗
            currentDialogType: _dialog_configs.DialogType.NONE
        };
    },

    methods: {
        // 点击关闭弹窗
        hiddenDialog: function hiddenDialog(el) {
            var target = el.target || el.srcElement;
            if (target.id !== 'rg-dialog') return;
            this.isShowDialog = false;
            this.contentComponentName = '';
        },
        setupComponent: function setupComponent(config, component, dialogData) {
            _vue2.default.component(component.name, component);
            this.dialogData = dialogData;
            this.closeOnClickOutside = config.closeOnClickOutside;
            this.dialogClass = config.dialogClass || _dialog_configs.DialogStyle.MIDDLE_DIALOG;
         ...
         */
        showDialog: function showDialog(dialogType) {
            var _this = this;
            ...
            var config = _dialog_configs.componentConfigs.find(function (item) {
                return item.type === dialogType;
            });
            if (!config) {
                console.error('\u627E\u4E0D\u5230\u5F39\u7A97\u7C7B\u578B' + dialogType + '\u5BF9\u5E94\u7684\u7EC4\u4EF6');
                return;
            }
            if (dialogType !== _dialog_configs.DialogType.LOADING) {
                this.showLoadingAfterAWhile();
            }
            this.dialogState = STATE_LOAD_PENNDING;
            config.loader().then(function (component) {
                // 在loading状态下用户关闭了弹框
                if (_this.dialogState !== STATE_LOAD_PENNDING && _this.dialogState !== STATE_LOADING) {
                    return;
                }
                _this.currentDialogType = dialogType;
                _this.dialogState = STATE_SHOWN;
                _this.setupComponent(config, component.default, dialogData);
            });
        },

        // 延迟一下，如果还没加载好，再显示加载动画
        showLoadingAfterAWhile: function showLoadingAfterAWhile() {
            var _this2 = this;

            // 如果当前窗口已经显示出来了，可以直接显示loading，否则pendding状态下会显示一个无内容的弹框。setTimeout期间如果要显示的对话框已经加载过，会在timeout之前就先完成loader的
            var duration = this.dialogState === STATE_SHOWN ? 0 : LOADING_DIALOG_PENDDING_TIME;
            setTimeout(function () {
                if (_this2.dialogState !== STATE_LOAD_PENNDING) {
                    return;
                }
                _this2.dialogState = STATE_LOADING;
                var config = _dialog_configs.componentConfigs.find(function (item) {
                    return item.type === _dialog_configs.DialogType.LOADING;
                });
                _this2.setupComponent(config, _loading2.default);
            }, duration);
        }
    },
    mounted: function mounted() {}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_loading_vue__ = __webpack_require__(268);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0929896e_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loading_vue__ = __webpack_require__(269);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-0929896e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0929896e_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loading_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(75)("83fb6bf2", content, true, {});
...
// module
exports.push([module.i, ".loading-dialog[data-v-0929896e]{height:200px;margin-bottom:65px}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"loading",rawName:"v-loading",value:(true),expression:"true"}],staticClass:"loading-dialog"})}
var staticRenderFns = []
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"rg-dialog-root",class:{'show-dialog': _vm.isShowDialog, 'hidden-dialog': !_vm.isShowDialog},attrs:{"id":"rg-dialog"},on:{"click":_vm.hiddenDialog}},[(_vm.isShowDialog)?_c(_vm.contentComponentName,{tag:"component",class:_vm.dialogClass,attrs:{"dialogData":_vm.dialogData}}):_vm._e()],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
var _toolsConst = __webpack_require__(274);

var _toolsConst2 = _interopRequireDefault(_toolsConst);

var _event = __webpack_require__(94);

var _fetchIe = __webpack_require__(275);
...
exports.default = {
    ...
    data: function data() {
        ...
        return {
            // tools-type
            toolsConst: _toolsConst2.default,
            // 当前选中的tools-type
            toolsSelected: _toolsConst2.default.TOOLS_OPTIONS.CLOSE,
            // 是否显示tools
            isShow: false,
            // 搜索内容
            search: '',
    ...
    methods: {
        /* Notice: 复杂的方法，写下说明 */
        // 点击打开tools
        openTools: function openTools(e, type) {
            // 阻止默认行为
            e.stopPropagation();
            if (!type) {
                type = 'innerArchive';
        ...
        clickCloseTools: function clickCloseTools(mouseDown) {
            // 将mousedown事件的元素传入，判断'所有文章/友情链接/关于我'三个按钮
            if (this.isShow && mouseDown.target.className !== 'click-show-tools') {
                this.isShow = false;
                this.toolsSelected = _toolsConst2.default.TOOLS_OPTIONS.CLOSE;
            }
        },

        // slider的滚动条置顶
        setScrollZero: function setScrollZero() {
        ...
        toggleTag: function toggleTag() {
            ...
            window.localStorage && window.localStorage.setItem(localTagKey, (0, _stringify2.default)(this.showTags));
        }
    },
    watch: {
        /* Notice: 写下说明 */
    ...
    mounted: function mounted() {
        ...
        var _loop = function _loop(i, len) {
            ...
            (0, _event.on)($em, 'click', function (e) {
                e.stopPropagation();
                _this.toolsSelected = _toolsConst2.default.TOOLS_OPTIONS.INNER_ARCHIVE;
                _this.isShow = true;
                _this.search = '#' + $em.innerHTML;
                _this.setScrollZero();
                return false;
            });
        };
        ...
        window.fetch(window.yiliaConfig.root + 'content.json?t=' + +new Date(), {
            ...
            _this.search = searchWording;
            searchWording !== '' && _this.handleSearch(searchWording);
        }).catch(function (err) {
            console.log(err);
            // fetch失败，显示提示语句
            _this.jsonFail = true;
        ...
        var localStorageTagKey = window.localStorage.getItem(localTagKey);
        var configTagKey = window.yiliaConfig && window.yiliaConfig.showTags ? true : false;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6f4d0ca0_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(500);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6f4d0ca0"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6f4d0ca0_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4e2efd79_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(503);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-4e2efd79"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4e2efd79_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
exports.default = {
    ...
    computed: {
        /* Notice: 写下computed数据的描述 */
        friendsArr: function friendsArr() {
            if (!this.friends) return [];
            var friends = JSON.parse(this.friends);
            return (0, _entries2.default)(friends);
        }
    },
    filters: {},
    methods: {
...
var $export = __webpack_require__(38);
var $entries = __webpack_require__(288)(true);
...
exports.default = {
    ...
    methods: {
        /* Notice: 复杂的方法，写下说明 */
        // 点击显示目录
        clickCatalog: function clickCatalog(e, catalogHtml) {
            this.$dialog.showDialog(_dialog_configs.DialogType.CATALOG, { catalogHtml: catalogHtml });
        }
    },
    watch: {
        /* Notice: 写下说明 */
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(75)("e8c7bf20", content, true, {});
...
// module
exports.push([module.i, ".tools-about-me-root[data-v-6f4d0ca0]{width:100%;height:100%}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"tools-about-me-root"},[(_vm.toolsSelected === 'aboutme')?_c('section',{staticClass:"tools-section tools-section-me"},[_c('div',{staticClass:"aboutme-wrap",attrs:{"id":"js-aboutme"},domProps:{"innerHTML":_vm._s(_vm.aboutme)}})]):_vm._e()])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(75)("767f77de", content, true, {});
...
// module
exports.push([module.i, ".tools-friends-root[data-v-4e2efd79]{width:100%;height:100%}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"tools-friends-root"},[(_vm.toolsSelected === 'friends')?_c('section',{staticClass:"tools-section tools-section-friends"},[_c('ul',{staticClass:"search-ul"},_vm._l((_vm.friendsArr),function(f){return _c('li',{staticClass:"search-li"},[_c('a',{staticClass:"search-title",attrs:{"href":f[1],"target":"_blank"}},[_c('i',{staticClass:"icon-youqinglianjie icon"}),_vm._v("\n                    "+_vm._s(f[0])+"\n                ")])])}))]):_vm._e()])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
